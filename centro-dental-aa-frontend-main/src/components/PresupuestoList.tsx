                            ...
                            <button
                                onClick={async () => {
                                    ...
                                    await printOdontogramaPDF({
                                        ...
                                        odontogramaMapa: selectedOdontogramProforma.odontograma_mapa || {},
                                        detalles: selectedOdontogramProforma.detalles,
                                        aranceles,
                                        numeroPlan: selectedOdontogramProforma.numero,
                                        fecha: selectedOdontogramProforma.fecha,
                                        action: 'print'
                                    });
                                }}
                                className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl transition-all shadow-md flex items-center gap-2 transform hover:-translate-y-0.5 active:scale-95"
                            >
                                <Printer size={18} />

...
import PacienteTabConsentimientos from './components/PacienteTabConsentimientos';
import PacienteTabInformes from './components/PacienteTabInformes';
import PacienteTabEstudios from './components/PacienteTabEstudios';
                                ...
                                <Route element={<ProtectedRoute moduleId="pacientes" />}>
                                    <Route element={<ProtectedRoute moduleId="pacientes-registro" />}>
                                        ...
                                        <Route path="/pacientes/:id" element={<PacientePerfil />}>
                                            ...
                                            <Route path="odontograma" element={<PacienteTabOdontograma />} />
                                            ...
                                            <Route path="consentimientos" element={<PacienteTabConsentimientos />} />
                                            <Route path="informes" element={<PacienteTabInformes />} />
                                            <Route path="estudios" element={<PacienteTabEstudios />} />

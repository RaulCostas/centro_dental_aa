...
const TrabajosLaboratoriosList: React.FC = () => {
    ...
    const handleSendWhatsApp = async (trabajo: TrabajoLaboratorio) => {
        if (!trabajo.laboratorio?.celular) {
            Swal.fire({
                icon: 'warning',
                title: 'Sin Celular',
                text: 'El laboratorio asignado a este trabajo no tiene un número de celular registrado.',
        ...
        try {
            ...
            Swal.fire({
                icon: 'success',
                title: '¡Enviado!',
                text: response.data.message || 'Orden de trabajo enviada por WhatsApp al laboratorio exitosamente',
                timer: 3000,
            ...
            let errorMessage = 'No se pudo enviar la orden de trabajo por WhatsApp';
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead className="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Enviar</th>
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {currentItems.map((trabajo, index) => (
                            <tr key={trabajo.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="p-3">
                                    <button
                                        onClick={() => handleSendWhatsApp(trabajo)}
                                        ...
                                        title="Enviar Orden por WhatsApp al Laboratorio"
                                    >
